...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xb989, 2 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xba99, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xbcad, 1  , 0x1000);  }
