...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa29a, 14 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xaa1a, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xabde, 1  , 0x1000);  }
