...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe196, 13 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xe716, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xe7e6, 1  , 0x1000);  }
