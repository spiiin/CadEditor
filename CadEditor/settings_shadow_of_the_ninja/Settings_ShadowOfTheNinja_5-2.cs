...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xb7c9, 7 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xba09, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xbb8d, 1  , 0x1000);  }
