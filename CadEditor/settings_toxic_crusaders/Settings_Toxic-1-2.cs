...
{  
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4b76-16*2, 3 , 16*13);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return ToxicUtils.getVideoChunk("chr1-2.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return ToxicUtils.readPalFromBin("pal1-2.bin"); }
