...
public class Data
{
  ...
  public static OffsetRec getVideoOffset()     { return new OffsetRec(0xCC10, 1 , 0xD00); }
  public static OffsetRec getVideoObjOffset()  { return new OffsetRec(0xCC10, 1 , 0xD00); }
  public static OffsetRec getBigBlocksOffset() { return new OffsetRec(0xE10 , 1 , 0x4000); }
  public static OffsetRec getBlocksOffset()    { return new OffsetRec(0x910 ,  1 , 0x4000); }
  public static OffsetRec getScreensOffset()   { return new OffsetRec(0x4490,32 , 0x40);   }
