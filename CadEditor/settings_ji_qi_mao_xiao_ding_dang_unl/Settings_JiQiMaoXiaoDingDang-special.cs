...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x14b10, 21, 16*16); }
  ...
  {
      return Utils.readBinFile("pal-special.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-special.bin", videoPageId);
  }
}