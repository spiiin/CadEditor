...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa6a0, 1 , 13*372, 13, 372);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x14a98, 1  , 0x1000);  }
  public int getBlocksCount()           { return 135; }
  public int getBigBlocksCount()        { return 135; }
  public int getPalBytesAddr()          { return 0x14a11; }
