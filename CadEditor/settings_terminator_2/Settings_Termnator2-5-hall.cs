...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x10, 1, 96*37, 96, 37); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xdf0, 1  , 0x1000);  }
  public int getBlocksCount()           { return 81; }
  public int getBigBlocksCount()        { return 81; }
  public int getPalBytesAddr()          { return 0xdf0 + 81*4; }
