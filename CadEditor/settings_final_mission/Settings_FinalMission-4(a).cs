...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xc47b, 8 , 16*15, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xd19c, 1  , 0x1000);  }
  ...
  {
      return Utils.readBinFile("pal4a.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr4a.bin", videoPageId);
  }
}