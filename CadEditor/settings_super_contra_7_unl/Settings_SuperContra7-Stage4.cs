...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe05b, 12 , 8*7+8, 8, 7);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xe35b, 1  , 0x1000);  }
  public int getBlocksCount()           { return 255; }
  public int getBigBlocksCount()        { return 255; }
  public int getPalBytesAddr()          { return 0xf34b; }
