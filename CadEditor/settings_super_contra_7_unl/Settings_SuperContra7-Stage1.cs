...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x802e, 7 , 8*7+8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x81ee, 1  , 0x1000);  }
  public int getBlocksCount()           { return 132; }
  public int getBigBlocksCount()        { return 132; }
  public int getPalBytesAddr()          { return 0x8a2e; }
