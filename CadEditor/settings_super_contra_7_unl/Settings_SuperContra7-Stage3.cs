...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xc037, 12 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xc337, 1  , 0x1000);  }
  public int getBlocksCount()           { return 112; }
  public int getBigBlocksCount()        { return 112; }
  public int getPalBytesAddr()          { return 0xca37; }
