...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1003d, 11 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x102fd, 1  , 0x1000);  }
  public int getBlocksCount()           { return 167; }
  public int getBigBlocksCount()        { return 167; }
  public int getPalBytesAddr()          { return 0x10d6d; }
