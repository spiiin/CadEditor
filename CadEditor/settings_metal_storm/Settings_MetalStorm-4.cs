...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10d4c, 4 , 8*8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SuperCUtils.getVideoChunk(new[] {"chr4-1(a).bin", "chr4-1(b).bin", "chr4-1(c).bin", "chr4-1(d).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SuperCUtils.readPalFromBin(new[] {"pal4-1(a).bin", "pal4-1(b).bin", "pal4-1(c).bin", "pal4-1(d).bin"}); }
