...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x20010, 4, 16*16); }
  ...
  public int getPalBytesAddr()          { return 0x21dff + 256*4; }
  ...
  {
      return Utils.readBinFile("pal7-2.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr7-2.bin", videoPageId);
  }
}