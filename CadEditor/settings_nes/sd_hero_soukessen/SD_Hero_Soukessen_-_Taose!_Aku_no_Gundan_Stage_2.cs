...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1312, 1 ,12*256, 12, 256);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1012, 1  , 0x1000);  }
  public int getBlocksCount()           { return 128; }
  public int getBigBlocksCount()        { return 128; }
  public int getPalBytesAddr()          { return 0x1212; }
