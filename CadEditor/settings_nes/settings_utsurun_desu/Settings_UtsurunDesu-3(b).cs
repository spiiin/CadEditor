...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4954, 9 , 16*12+48, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x40a8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 180; }
  public int getBigBlocksCount()        { return 180; }
  public int getPalBytesAddr()          { return 0x4388; }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal3(b).bin"); }
