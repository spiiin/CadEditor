...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr1b.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal1b.bin"}); }
  public SetPalFunc           setPalFunc()    { return null;}
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x4d74, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0x4d74 + getBigBlocksCount()*4; }
  public int getBigBlocksCount() { return 111; }
}