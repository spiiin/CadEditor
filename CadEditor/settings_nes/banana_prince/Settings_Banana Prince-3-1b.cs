...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x646a, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0x646a + getBigBlocksCount()*4; }
  public int getBigBlocksCount() { return 150; }
}