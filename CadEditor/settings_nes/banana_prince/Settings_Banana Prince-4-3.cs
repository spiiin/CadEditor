...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xA7F8,14, 64, 8, 8);   } 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr4b.bin"}); }
