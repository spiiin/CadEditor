...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xB247,13, 64, 8, 8);   } 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xB587, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xB587 + getBigBlocksCount()*4; }
