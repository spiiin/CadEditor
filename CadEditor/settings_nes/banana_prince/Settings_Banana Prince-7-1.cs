...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xCC7A, 7, 64, 8, 8);   } 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xD17A, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xD17A + getBigBlocksCount()*4; }
