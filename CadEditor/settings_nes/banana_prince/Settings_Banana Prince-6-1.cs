...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xC035, 7, 64, 8, 8);   } 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xc7b5, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xc7b5 + getBigBlocksCount()*4; }
