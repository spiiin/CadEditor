...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xA040,10, 64, 8, 8);   } 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xA2C0, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xA2C0 + getBigBlocksCount()*4; }
