...
{ 
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal5b.bin"}); }
  public SetPalFunc           setPalFunc()    { return null;}
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xBA7f, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xBA7f + getBigBlocksCount()*4; }
