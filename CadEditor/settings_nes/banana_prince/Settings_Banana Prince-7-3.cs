...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr7b.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal7b.bin"}); }
  public SetPalFunc           setPalFunc()    { return null;}
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xd79a, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0xd79a + getBigBlocksCount()*4; }
  public int getBigBlocksCount() { return 143; }
}