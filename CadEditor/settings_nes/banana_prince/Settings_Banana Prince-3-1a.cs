...
{ 
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x6132, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0x6132 + getBigBlocksCount()*4; }
  public int getBigBlocksCount() { return 36; }
}