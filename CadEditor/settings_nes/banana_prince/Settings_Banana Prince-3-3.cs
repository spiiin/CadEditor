...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0x6DEA, 9, 64, 8, 8);   } 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr3d.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal3d.bin"}); }
  public SetPalFunc           setPalFunc()    { return null;}
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x702A, 1 , 0x4000); }
  public int getPalBytesAddr()          { return 0x702A + getBigBlocksCount()*4; }
