...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec( 0x14b9a, 1 , 32*24, 32, 24);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x143FA, 1  , 0x1000);  }
  public int getBlocksCount()           { return 106; }
  public int getBigBlocksCount()        { return 106; }
  public int getPalBytesAddr()          { return 0x142FA; }
