...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec( 0x12190, 1 , 24*24, 24, 24);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x11760, 1  , 0x1000);  }
  public int getBlocksCount()           { return 51; }
  public int getBigBlocksCount()        { return 51; }
  public int getPalBytesAddr()          { return 0x11660; }
