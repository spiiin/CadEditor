...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec( 0x13030, 1 , 32*24, 32, 24);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x124D0, 1  , 0x1000);  }
  public int getBlocksCount()           { return 58; }
  public int getBigBlocksCount()        { return 58; }
  public int getPalBytesAddr()          { return 0x123D0; }
