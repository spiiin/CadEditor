...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x384f, 2 , 16*5, 16, 5);   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal-intro4.bin"); }
