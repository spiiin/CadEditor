...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x77ce, 1 , 16*15, 16, 15);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr2-3.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal2-3.bin"); }
