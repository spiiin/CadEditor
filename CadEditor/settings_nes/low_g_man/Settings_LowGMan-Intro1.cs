...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x38ef, 1 , 16*5, 16, 5);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk("chr-intro1.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal-intro1.bin"); }
