...
{  
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr1-1.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal1-1.bin"); }
