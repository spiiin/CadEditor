...
public class Data 
{
  public OffsetRec[] getScreensOffsetsForLevels() {
    var ans = new OffsetRec[] {
      new OffsetRec(0x713e, 2 , 16*15, 16, 15),
      new OffsetRec(0x731e, 3 , 16*12, 16, 12),
      new OffsetRec(0x755e, 1 , 16*15, 16, 15),
      new OffsetRec(0x764e, 2 , 16*12, 16, 12),
      new OffsetRec(0x77ce, 1 , 16*15, 16, 15),
      new OffsetRec(0x78be, 2 , 16*12, 16, 12),
    };
    return ans;  
  }
