...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x393f, 1 , 16*5, 16, 5);   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal-intro2.bin"); }
