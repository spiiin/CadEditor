...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xde02, 4 , 8*8, 8, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return ZenUtils.getVideoChunk(new[] {"chr7.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return ZenUtils.readPalFromBin(new[] {"pal8.bin"}); }
