...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10e2, 16 , 16*13, 16, 13);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1de2, 1  , 0x1000);  }
  public int getBlocksCount()           { return 122; }
  public int getBigBlocksCount()        { return 122; }
  public int getPalBytesAddr()          { return 0x1fce; }
