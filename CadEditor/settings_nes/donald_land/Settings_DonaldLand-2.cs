...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2b, 16 , 16*13, 16, 13);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xd2b, 1  , 0x1000);  }
  public int getBlocksCount()           { return 154; }
  public int getBigBlocksCount()        { return 154; }
  public int getPalBytesAddr()          { return 0xf93; }
