...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x90f6, 16 , 16*13, 16, 13);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x9df6, 1  , 0x1000);  }
  public int getBlocksCount()           { return 176; }
  public int getBigBlocksCount()        { return 176; }
  public int getPalBytesAddr()          { return 0xa0b6; }
