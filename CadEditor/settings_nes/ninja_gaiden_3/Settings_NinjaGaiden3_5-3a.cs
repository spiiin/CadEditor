...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1616, 1 , 6*8, 6, 8);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr5-3a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal5-3a.bin");
  }
}