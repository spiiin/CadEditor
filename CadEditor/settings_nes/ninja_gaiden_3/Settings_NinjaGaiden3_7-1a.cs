...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1aec, 1 , 6*64, 6, 64);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr7-1a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal7-1a.bin");
  }
}