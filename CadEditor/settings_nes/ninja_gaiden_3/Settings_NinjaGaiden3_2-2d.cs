...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x670, 1 , 6*16, 6, 16);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr2-2a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal2-2a.bin");
  }
}