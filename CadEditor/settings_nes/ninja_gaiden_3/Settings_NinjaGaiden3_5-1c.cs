...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1216, 1 , 6*32, 6, 32);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr5-1a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal5-1a.bin");
  }
}