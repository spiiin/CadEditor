...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2932, 1 , 16*15, 16, 15);   }
  public bool isBuildScreenFromSmallBlocks() { return true; }

  public GetVideoChunkFunc    getVideoChunkFunc()    { return getVideoChunk;   }
  public SetVideoChunkFunc    setVideoChunkFunc()    { return null; }

  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x4a8f , 1  , 0x1000);  }
  public int getBlocksCount()           { return 104; }
  public int getBigBlocksCount()        { return 104; }
  public GetBlocksFunc getBlocksFunc() { return Utils.getBlocksLinear2x2withoutAttrib;}
  public SetBlocksFunc setBlocksFunc() { return Utils.setBlocksLinearWithoutAttrib;}
  public int getPalBytesAddr()          { return 0x3dd3; }
  ...
  {
      return Utils.readBinFile("pal-ending.bin");
  }

  public byte[] getVideoChunk(int videoPageId)
  {
     return Utils.readVideoBankFromFile("chr-ending.bin", videoPageId);
  }
