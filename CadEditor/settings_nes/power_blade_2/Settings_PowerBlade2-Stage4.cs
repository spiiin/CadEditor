...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8dae, 1 , 8*155, 8, 155);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr4(a).bin", "chr4(b).bin", "chr4(c).bin"}); }
