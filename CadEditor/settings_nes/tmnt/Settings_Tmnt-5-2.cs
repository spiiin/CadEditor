...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x6949, 16, 48, 8, 6); }
  ...
  public OffsetRec getPalOffset()     { return new OffsetRec(0x1f977, 16, 16   ); }
  ...
  public byte[] getPallete(int palId)
  {
    var pallete = new byte[] { 
      ...
      0x0f, 0x01, 0x12, 0x3a, 0x0f, 0x08, 0x28, 0x20
    }; 
    return pallete;
  }
}