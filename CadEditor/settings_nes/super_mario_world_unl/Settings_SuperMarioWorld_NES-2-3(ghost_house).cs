...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x6910, 3, 16*16, 16, 16); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x47010, 1  , 0x1000);  }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal2-3(a).bin"}); }
