...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x30010, 20, 16*16, 16, 16); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x44010, 1  , 0x1000);  }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal7-1.bin"}); }
