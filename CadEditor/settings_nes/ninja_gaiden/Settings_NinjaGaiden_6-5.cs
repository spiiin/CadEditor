...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x23e0, 1 , 6*8, 6, 8);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr6-5.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal6-5.bin");
  }
}