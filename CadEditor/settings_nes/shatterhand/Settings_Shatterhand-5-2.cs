...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xE887, 17, 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal5-2.bin"}); }
