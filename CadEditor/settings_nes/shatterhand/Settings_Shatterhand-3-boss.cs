...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xf434, 1, 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal3-3.bin"}); }
