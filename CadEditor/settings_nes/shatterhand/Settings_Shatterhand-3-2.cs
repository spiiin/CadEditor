...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xF6B4, 9, 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[] {"pal3-2.bin"}); }
