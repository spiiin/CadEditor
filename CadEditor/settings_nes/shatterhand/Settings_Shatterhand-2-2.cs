...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8EDF, 7 , 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal2-2.bin"}); }
