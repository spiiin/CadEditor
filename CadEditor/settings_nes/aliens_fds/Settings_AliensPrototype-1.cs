...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x16347, 1 , 10*256, 10, 256);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x16d47, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public int getBigBlocksCount()        { return 64; }
  public int getPalBytesAddr()          { return 0x16e47; }
