...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xd20, 4 , 16*15+64, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x15f0, 1  , 0x1000);  }
  public int getBlocksCount()           { return 136; }
  public int getBigBlocksCount()        { return 136; }
  public int getPalBytesAddr()          { return 0xe10; }
