...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2130, 6 , 16*15+64, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x3690, 1  , 0x1000);  }
  public int getBlocksCount()           { return 136; }
  public int getBigBlocksCount()        { return 136; }
  public int getPalBytesAddr()          { return 0x2220; }
