...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xbd1b, 1 , 16*6, 16, 6);   }
  ...
  {
      return Utils.readBinFile("pal-intro5.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-intro5.bin", videoPageId);
  }
}