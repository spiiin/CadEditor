...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xbb53, 1 , 8*3, 8, 3);   }
  ...
  {
      return Utils.readBinFile("pal-logo.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-logo.bin", videoPageId);
  }
}