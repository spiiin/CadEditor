...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x240, 1 , 6*72, 6, 72);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr2-1a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal2-1a.bin");
  }
}