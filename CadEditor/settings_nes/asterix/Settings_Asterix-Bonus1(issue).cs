...
public class Data 
{
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk("chr-bonus1.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal-bonus1.bin"); }
