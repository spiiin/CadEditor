...
public class Data 
{
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk("chr1-4.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal1-4.bin"); }
