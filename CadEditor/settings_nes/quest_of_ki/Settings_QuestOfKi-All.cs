...
public class Data 
{ 
  //public OffsetRec getScreensOffset()  { return new OffsetRec(0x8010, 50 , 32*8, 32, 8);   }
  ...
  {
      return Utils.readBlocksLinear(Globals.romdata,  ConfigScript.getTilesAddr(blockIndex), 4, 4, ConfigScript.getBlocksCount(blockIndex), false);
  }

  public static void setBlocks(int blockIndex, ObjRec[] blocksData)
  {
      Utils.writeBlocksLinear(blocksData, Globals.romdata, ConfigScript.getTilesAddr(blockIndex), ConfigScript.getBlocksCount(blockIndex), false);
  }
}