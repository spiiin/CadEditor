...
{  
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return ToxicUtils.getVideoChunk("chr6-3.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return ToxicUtils.readPalFromBin("pal6-3.bin"); }
