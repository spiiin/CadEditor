...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x200bb, 19 , 8*6, 8, 6); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x20451, 1  , 0x1000);  }
  public int getBlocksCount()           { return 145; }
  public int getBigBlocksCount()        { return 145; }
  public int getPalBytesAddr()          { return 0x20D61; }
