...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr4-1(a).bin", "chr4-1(b).bin", "chr4-1(c).bin", "chr4-1(d).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal4-1(a).bin", "pal4-1(b).bin", "pal4-1(c).bin", "pal4-1(d).bin"}); }
