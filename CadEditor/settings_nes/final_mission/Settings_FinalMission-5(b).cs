...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x11a31, 2 , 16*15, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x11fb4, 1  , 0x1000);  }
  ...
  {
      return Utils.readBinFile("pal5b.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr5b.bin", videoPageId);
  }
}