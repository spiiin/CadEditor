...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10591, 22 , 16*15, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x11d02, 1  , 0x1000);  }
  ...
  {
      return Utils.readBinFile("pal5a.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr5a.bin", videoPageId);
  }
}