...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xc8b9, 9 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xcbf5, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xce3d, 1  , 0x1000);  }
