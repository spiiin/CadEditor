...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe696, 2 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xfe06, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xfee6, 1  , 0x1000);  }
