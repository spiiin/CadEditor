...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xc6b9, 8 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xcaf9, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xcce5, 1  , 0x1000);  }
