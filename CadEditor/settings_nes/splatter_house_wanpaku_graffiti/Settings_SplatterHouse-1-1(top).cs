...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x3400, 1 , 3*24, 3, 24);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr1-1(c).bin"}); }
