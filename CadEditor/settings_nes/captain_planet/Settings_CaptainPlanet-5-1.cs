...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4018, 1, 255*4, 255, 4); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x4414, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr5-1.bin", 0);
  }
