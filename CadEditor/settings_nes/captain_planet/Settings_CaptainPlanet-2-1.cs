...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10b0, 1, 255*4, 255, 4); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x14ac, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr2-1.bin", 0);
  }
