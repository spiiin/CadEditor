...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2088, 1, 255*4, 255, 4); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x2484, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr3-1.bin", 0);
  }
