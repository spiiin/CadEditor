...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x173b0, 1, 64*30, 64, 30); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x14c0c, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr4-2.bin", 0);
  }
