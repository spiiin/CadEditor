...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x16c30, 1, 64*30, 64, 30); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x14018, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr3-2.bin", 0);
  }
