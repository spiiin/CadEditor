...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa058, 23 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xb6d8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 182; }
  public int getBigBlocksCount()        { return 182; }
  public int getPalBytesAddr()          { return 0xbad8; }
