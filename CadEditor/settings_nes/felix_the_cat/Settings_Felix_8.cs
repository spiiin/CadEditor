...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x0, 1 , 24*(256*1+128), 24, 256*1+128);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return FelixUtils.getVideoChunk("chr8.bin");   }
  public SetVideoChunkFunc    setVideoChunkFunc()    { return null; }
  
  public bool isBuildScreenFromSmallBlocks() { return true; }
  
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x17aaa, 1  , 0x1000);  }
  ...
  public GetPalFunc           getPalFunc()           { return FelixUtils.readPalFromBin("pal8.bin"); }
