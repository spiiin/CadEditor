...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x0, 1 , 24*(256*3), 24, 2563);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return FelixUtils.getVideoChunk("chr9.bin");   }
  public SetVideoChunkFunc    setVideoChunkFunc()    { return null; }
  
  public bool isBuildScreenFromSmallBlocks() { return true; }
  
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x142e8, 1  , 0x1000);  }
  ...
  public GetPalFunc           getPalFunc()           { return FelixUtils.readPalFromBin("pal9.bin"); }
