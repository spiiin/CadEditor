...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x58, 18 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x16d8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 171; }
  public int getBigBlocksCount()        { return 171; }
  public int getPalBytesAddr()          { return 0x1ad8; }
