...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa23a, 31 , 16*13, 16, 13);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xbb6a, 1  , 0x1000);  }
  public int getBlocksCount()           { return 194; }
  public int getBigBlocksCount()        { return 194; }
  public int getPalBytesAddr()          { return 0xbe72; }
