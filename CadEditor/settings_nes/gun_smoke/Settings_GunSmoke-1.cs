...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0x410, 1, 8*128, 8, 128);  }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()             { return GunSmokeUtils.getVideoChunk(new[] {"chr1.bin", "chr1-2.bin"}); }
  ...
  public GetPalFunc           getPalFunc()                    { return GunSmokeUtils.readPalFromBin(new[] {"pal1.bin"}); }
