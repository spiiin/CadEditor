using CadEditor;
using System;
//css_include mickey_mouse_3_yume_fuusen/MickeyUtils.cs;

public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec( 0x417E, 32 , 8*6, 8, 6);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x4B7E, 1  , 0x1000);  }
  public int getBlocksCount()           { return 256; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x477E, 1  , 0x1000);  }
  public int getBigBlocksCount()        { return 256; }
  public int getPalBytesAddr()          { return 0x4B7E + 128*4; }
