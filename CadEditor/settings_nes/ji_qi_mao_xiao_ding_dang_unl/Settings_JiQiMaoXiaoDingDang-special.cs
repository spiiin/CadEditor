...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr-special.bin"}); }
  ...
  public int getPalBytesAddr()          { return 0x14410 + 256*4; }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal-special.bin"}); }
