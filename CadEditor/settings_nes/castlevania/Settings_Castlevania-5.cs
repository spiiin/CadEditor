...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x11b51, 19 , 8*6, 6, 8); }	
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x11ee2, 1  , 0x1000);  } 
  ...
  public byte[] getVideoChunk(int videoPageId)
  {
   ...
   return Utils.readVideoBankFromFile("chr5.bin", 0);		//c018
  ...
  public byte[] getPallete(int palId)
  {
		...
		return Utils.readBinFile("pal5.bin");       // 1ce86
