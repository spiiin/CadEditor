...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x12217, 14 , 8*6, 6, 8); }	
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x12548, 1  , 0x1000);  } 
  ...
  {
   return Utils.readVideoBankFromFile("chr6.bin", 0);		//d198
  ...
  public byte[] getPallete(int palId)
  {
		...
		return Utils.readBinFile("pal6.bin");       // 1ce99
