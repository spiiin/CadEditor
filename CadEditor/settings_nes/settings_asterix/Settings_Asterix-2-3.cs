...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x62ac, 1 , 12*80, 12, 80);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return AsterixUtils.getVideoChunk("chr2-3.bin");   }
  ...
  public int getPalBytesAddr()          { return 0x616c; }
  
  public GetBlocksFunc        getBlocksFunc() { return Utils.getBlocksLinear2x2withoutAttrib;}
  public SetBlocksFunc        setBlocksFunc() { return Utils.setBlocksLinearWithoutAttrib;}
  public GetPalFunc           getPalFunc()           { return AsterixUtils.readPalFromBin("pal2-3.bin"); }
