...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xca22, 1 , 16*15, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xcee6, 1  , 0x1000);  }
  public int getBlocksCount()           { return 128; }
  public int getBigBlocksCount()        { return 128; }
  public int getPalBytesAddr()          { return 0xcf4e; }
  ...
  {
     return Utils.readVideoBankFromFile("chr1(c).bin", videoPageId);
  }
}