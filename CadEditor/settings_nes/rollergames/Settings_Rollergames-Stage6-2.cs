...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2f49, 17 , 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return RollergamesUtils.readPalFromBin(new[] {"pal6-2.bin", "pal6-1.bin"}); }
