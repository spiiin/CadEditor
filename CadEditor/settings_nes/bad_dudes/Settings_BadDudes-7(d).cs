...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xad40, 5 , 16*15, 16, 15);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr-heli.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal-heli.bin"}); }
