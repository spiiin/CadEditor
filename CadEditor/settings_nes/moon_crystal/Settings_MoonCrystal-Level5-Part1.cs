...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1c2a1, 20 , 16*15, 16, 15);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return MoonUtils.getVideoChunk("chr5.bin");   }
