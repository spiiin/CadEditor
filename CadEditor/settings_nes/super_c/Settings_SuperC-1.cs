...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xA068, 17 , 8*8, 8, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return  SharedUtils.getVideoChunk(new[] {"chr1_000.bin", "chr1_001.bin", "chr1_002.bin"}); }
