...
{
  public override OffsetRec getScreensOffset()  { return new OffsetRec(0x17df7, 15 , 3*2, 2, 3);    }
  public override int getVideoIndex1()          { return 0x64; }
  public override int getVideoIndex2()          { return 0x66; }
  public override OffsetRec getBlocksOffset()   { return new OffsetRec(0x1781d ,1  , 0x4000); }
  public override int getBlocksCount()          { return 128; }
  
  public override OffsetRec getBigBlocksOffsetHierarchy(int hierarchyLevel)
  { 
    if (hierarchyLevel == 0) { return new OffsetRec(0x17a9d, 1  , 0x4000); }
    if (hierarchyLevel == 1) { return new OffsetRec(0x17c79, 1  , 0x4000); }
    if (hierarchyLevel == 2) { return new OffsetRec(0x17d9d, 1  , 0x4000); }
    return new OffsetRec(0x0, 1  , 0x4000);
  }
  
  public override int getBigBlocksCountHierarchy(int hierarchyLevel)
  { 
    if (hierarchyLevel == 0) { return 119; }
    if (hierarchyLevel == 1) { return 73; }
    if (hierarchyLevel == 2) { return 45;  }
    return 256;
  }
