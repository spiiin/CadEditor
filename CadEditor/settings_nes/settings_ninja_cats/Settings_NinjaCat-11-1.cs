...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(10005, 3 , 8*5, 5, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()             { return NinjaCatUtils.getVideoChunk("chr11-1.bin");   }
  ...
  public GetPalFunc           getPalFunc()                    { return NinjaCatUtils.readPalFromBin("pal11-1.bin"); }
