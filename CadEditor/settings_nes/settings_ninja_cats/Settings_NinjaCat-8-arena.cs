...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(7617, 1 , 8*5, 5, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()             { return NinjaCatUtils.getVideoChunk("chr8-2.bin");   }
  ...
  public GetPalFunc           getPalFunc()                    { return NinjaCatUtils.readPalFromBin("pal8-2.bin"); }
