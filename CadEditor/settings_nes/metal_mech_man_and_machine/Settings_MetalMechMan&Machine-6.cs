...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe757, 26 , 16*15, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xe320, 1  , 0x1000);  }
  public int getBlocksCount()           { return 180; }
  public int getBigBlocksCount()        { return 180; }
  public int getPalBytesAddr()          { return 0xe6a3; }
