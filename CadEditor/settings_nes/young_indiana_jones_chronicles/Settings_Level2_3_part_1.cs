...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec( 0xe290, 1 , 6*160, 6, 160);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xdb90 , 1  , 0x1000);  }
  public int getPalBytesAddr()          { return 0xe650; }
