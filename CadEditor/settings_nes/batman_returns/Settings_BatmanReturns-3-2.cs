...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x6580, 4 , 8*6, 8, 6);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SuperCUtils.getVideoChunk(new[] {"chr3-2.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SuperCUtils.readPalFromBin(new[] {"pal3-2.bin"}); }
