...
public class Data
{ 
    public OffsetRec getScreensOffset()   { return new OffsetRec(0x16184 , 2  , 64, 8, 8);      }
    ...
    public GetVideoChunkFunc    getVideoChunkFunc()    { return ThreeUtils.getVideoChunk(new[] {"chr5-3(c).bin"}); }
