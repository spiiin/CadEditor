...
public class Data
{
    public OffsetRec getScreensOffset()   { return new OffsetRec(0x119D0 , 2  , 64, 8, 7);      }
    
    public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x118BC,  1  , 0x4000);  }
    ...
    public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1177c , 1  , 0x440);   }
    public int getBlocksCount()           { return 80; }
    public int getPalBytesAddr()          { return 0x11a48; }
    ...
    public GetVideoChunkFunc    getVideoChunkFunc()    { return ThreeUtils.getVideoChunk(new[] {"chr2-5.bin"}); }
    public SetVideoChunkFunc    setVideoChunkFunc()    { return null; }
    
    public OffsetRec getPalOffset() { return new OffsetRec(0x0 , 1   , 16); }
    public GetPalFunc getPalFunc()  { return ThreeUtils.readPalFromBin(new[] {"pal2-5.bin"}); }
