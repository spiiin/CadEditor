...
public class Data
{ 
    public OffsetRec getScreensOffset()   { return new OffsetRec(0x16a18 , 2  , 64, 8, 8);      }
    ...
    public GetVideoChunkFunc    getVideoChunkFunc()    { return ThreeUtils.getVideoChunk(new[] {"chr5-4(a).bin"}); }
