...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x174de, 6 , 8*8, 8, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x179ce, 1  , 0x1000);  }
  public int getBlocksCount()           { return 64; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x17c7e, 1  , 0x1000);  }
