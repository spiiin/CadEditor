...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xE607, 10, 8*8, 8, 8);   }

  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xECC7, 1, 0x400); }
  public int getPalBytesAddr()          { return 0xF293; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xEF97, 1, 0x4000);  }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal5.bin"}); }
