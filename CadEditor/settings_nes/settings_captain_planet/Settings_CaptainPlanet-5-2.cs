...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8012, 1, 64*30, 64, 30); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1601a, 1, 0x1000); }
  ...
  {
      return Utils.readVideoBankFromFile("chr5-2.bin", 0);
  }
