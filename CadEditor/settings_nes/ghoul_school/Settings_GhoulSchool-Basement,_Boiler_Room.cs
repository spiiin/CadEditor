...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x173b8, 1, 12*192, 12, 192); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x17034, 1  , 0x1000);  }
  public int getBlocksCount()           { return 176; }
  public int getBigBlocksCount()        { return 176; }
  public int getPalBytesAddr()          { return 0x172f4; }
  ...
  {
     return Utils.readVideoBankFromFile("chr-basement.bin", videoPageId);
  }
}