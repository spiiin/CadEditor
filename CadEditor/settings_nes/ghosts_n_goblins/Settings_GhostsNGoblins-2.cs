...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x637a, 22 , 16*15, 16, 15);   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal2(a).bin", "pal2(b).bin", "pal2(c).bin"}); }
