...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x1b95d, 5, 16*16, 16, 16); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1aa5f, 1  , 0x1000);  }
  public int getBlocksCount()           { return 255; }
  public int getBigBlocksCount()        { return 255; }
  public int getPalBytesAddr()          { return 0x1ae5b; }
