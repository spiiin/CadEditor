...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8b33, 13 , 8*6, 8, 6);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr7(a).bin", "chr7(b).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal7(a).bin", "pal7(b).bin"}); }
