...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x86a, 1 , 64*12, 64, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x463e, 1  , 0x1000);  }
  public int getBlocksCount()           { return 256; }
  public int getBigBlocksCount()        { return 256; }
  public int getPalBytesAddr()          { return 0x4a3e; }
  ...
  {
      return Utils.readBinFile("pal1-5.bin");
  }
