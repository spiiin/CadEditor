...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x5c0, 12 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xc0, 1  , 0x1000);  }
  public int getBlocksCount()           { return 236; }
  public int getBigBlocksCount()        { return 236; }
  public int getPalBytesAddr()          { return 0x4c0; }
