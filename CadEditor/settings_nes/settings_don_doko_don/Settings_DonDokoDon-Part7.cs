...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2f70, 6 , 16*15+64, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x39b4, 1  , 0x1000);  }
  public int getBlocksCount()           { return 109; }
  public int getBigBlocksCount()        { return 109; }
  public int getPalBytesAddr()          { return 0x3060; }
