...
public class Data:CapcomBase
{
  ...
  private static int LEVEL_NO     = 0;
  public OffsetRec getPalOffset()       { return new OffsetRec(0x415A0 + LEVEL_OFFSET* LEVEL_NO, 1  , 16);     }
  public OffsetRec getVideoOffset()     { return new OffsetRec(0x20010 + CHR_OFFSET* LEVEL_NO, 1   , 0x1000); }
  public OffsetRec getVideoObjOffset()  { return new OffsetRec(0x20010 + CHR_OFFSET* LEVEL_NO, 1   , 0x1000); } //
