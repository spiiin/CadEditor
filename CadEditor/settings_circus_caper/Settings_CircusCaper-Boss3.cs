...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8948, 1 , 16*15);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return CircusCaperUtils.getVideoChunk("chr3(b).bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return CircusCaperUtils.readPalFromBin("pal3(d).bin"); }
