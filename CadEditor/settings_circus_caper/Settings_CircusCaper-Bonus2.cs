...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8a48, 1 , 16*12, 16, 12);   }
  ...
  public GetPalFunc           getPalFunc()           { return CircusCaperUtils.readPalFromBin("pal2(b).bin"); }
