...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8828, 1 , 16*10, 16, 10);   }
  ...
  public int getPalBytesAddr()          { return 0x88c8+1; }
  
  public GetBlocksFunc        getBlocksFunc() { return Utils.getBlocksLinear2x2withoutAttrib;}
  public SetBlocksFunc        setBlocksFunc() { return Utils.setBlocksLinearWithoutAttrib;}
  public GetPalFunc           getPalFunc()           { return CircusCaperUtils.readPalFromBin("pal1(b).bin"); }
