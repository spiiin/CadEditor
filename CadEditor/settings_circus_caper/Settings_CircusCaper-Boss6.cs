...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa4b0, 1 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xa370, 1  , 0x1000);  }
  public int getBlocksCount()           { return 76; }
  public int getBigBlocksCount()        { return 76; }
  public int getPalBytesAddr()          { return 0xa570+1; }
  
  public GetBlocksFunc        getBlocksFunc() { return Utils.getBlocksLinear2x2withoutAttrib;}
  public SetBlocksFunc        setBlocksFunc() { return Utils.setBlocksLinearWithoutAttrib;}
  public GetPalFunc           getPalFunc()           { return CircusCaperUtils.readPalFromBin("pal6(c).bin"); }
