...
public class Data
{
  ...
  public static OffsetRec getVideoOffset()     { return new OffsetRec(0xE410, 1 , 0xD00); }
  public static OffsetRec getVideoObjOffset()  { return new OffsetRec(0xE410, 1 , 0xD00); }
  public static OffsetRec getBigBlocksOffset() { return new OffsetRec(0x2010, 1 , 0x4000); }
  public static OffsetRec getBlocksOffset()    { return new OffsetRec(0x1B10,  1 , 0x4000); }
  public static OffsetRec getScreensOffset()   { return new OffsetRec(0x4DD0, 32 , 0x40);   }
