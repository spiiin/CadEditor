...
{ 
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10c5f, 14 , 8*15, 8, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x103aF , 1  , 0x1000);  }
  public int getBlocksCount()           { return 256; }
  public int getBigBlocksCount()        { return 256; }
  public GetBlocksFunc getBlocksFunc() { return Utils.getBlocksLinear4x2withoutAttrib;}
  public SetBlocksFunc setBlocksFunc() { return Utils.setBlocksLinearWithoutAttrib;}
  public int getPalBytesAddr()          { return 0x14190; }
  ...
  public byte[] getPallete(int palId)
  {
    var pallete = new byte[] { 
      0x0f, 0x27, 0x17, 0x06, 0x0f, 0x23, 0x14, 0x04,
      0x0f, 0x10, 0x00, 0x0b, 0x0f, 0x10, 0x00, 0x08
    }; 
    return pallete;
  }
