...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2BCF, 14 , 8*8);   }
  ...
  public GetPalFunc           getPalFunc()           { return SuperCUtils.readPalFromBin(new[] {"pal2.bin", "pal2-2.bin", "pal2-3.bin"}); }
