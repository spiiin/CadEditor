...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x110, 100 , 4*15, 4, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x801c, 1  , 0x1000);  }
  public int getBlocksCount()           { return 128; }
  public int getBigBlocksCount()        { return 128; }
  public int getPalBytesAddr()          { return 0x821c; }
