...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa2f4, 16 , 16*8, 16, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xaaf1, 1  , 0x1000);  }
  public int getBlocksCount()           { return 162; }
  public int getBigBlocksCount()        { return 162; }
  public int getPalBytesAddr()          { return 0xa24f; }
