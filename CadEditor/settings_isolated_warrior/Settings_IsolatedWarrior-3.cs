...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2202, 16 , 16*8, 16, 8);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x2a02, 1  , 0x1000);  }
  public int getBlocksCount()           { return 159; }
  public int getBigBlocksCount()        { return 159; }
  public int getPalBytesAddr()          { return 0x2163; }
