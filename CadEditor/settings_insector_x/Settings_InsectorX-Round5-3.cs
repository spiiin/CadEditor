...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x12550, 3 , 16*13+96, 16, 13);   }
  ...
  public MapInfo[] makeMapsInfo()
  {
     ...
     int actualScreenSize = getScreensOffset().width * getScreensOffset().height * ConfigScript.getWordLen();
