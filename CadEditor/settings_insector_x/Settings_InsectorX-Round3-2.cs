...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8550, 9 , 16*13+96);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x8030, 1  , 0x1000);  }
  public int getBlocksCount()           { return 195; }
  public int getBigBlocksCount()        { return 195; }
