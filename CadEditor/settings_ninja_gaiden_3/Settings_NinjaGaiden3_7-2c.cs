...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1e0c, 1 , 8*22, 8, 22);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr7-2a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal7-2a.bin");
  }
}