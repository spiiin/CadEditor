...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1f7c, 1 , 8*22, 8, 22);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr7-3a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal7-3a.bin");
  }
}