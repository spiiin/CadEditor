...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x234c, 1 , 6*8, 6, 8);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr7-6a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal7-6a.bin");
  }
}