...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xc46, 1 , 6*88, 6, 88);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr4-1a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal4-1a.bin");
  }
}