...
public class Data 
{
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x18d6, 1 , 8*30, 8, 30);   }
  ...
  {
     return Utils.readVideoBankFromFile("chr6-2a.bin", videoPageId);
  }
  
  public byte[] getPallete(int palId)
  {
      return Utils.readBinFile("pal6-2a.bin");
  }
}