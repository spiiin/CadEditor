...
public class Data
{
  ...
  public OffsetRec getPalOffset()       { return new OffsetRec(0xe962e, 1, 64    );   }
  public OffsetRec getVideoOffset()     { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getVideoObjOffset()  { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x13373e, 1, 0x8000);  }
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getScreensOffset()   { return new OffsetRec(0, 1, 53*165);   }
  public int getBigBlocksCount()        { return 0x1000; }
  public int getScreenWidth()           { return 53; }
  public int getScreenHeight()          { return 165; }
  ...
  private string BACK_NAME   = "SegaJungleBookBack_2.bin";
  ...
  {
    return Utils.readBinFile("videoBack_2.bin");
  }
