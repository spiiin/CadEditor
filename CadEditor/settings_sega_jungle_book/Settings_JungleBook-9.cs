...
public class Data
{
  ...
  public OffsetRec getPalOffset()       { return new OffsetRec(0xe996e, 1, 64    );   }
  public OffsetRec getVideoOffset()     { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getVideoObjOffset()  { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x1892a6, 1, 0x8000);  }
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getScreensOffset()   { return new OffsetRec(0, 1, 131*81);   }
  public int getBigBlocksCount()        { return 0x1000; }
  public int getScreenWidth()           { return 131; }
  public int getScreenHeight()          { return 81; }
  ...
  private string BACK_NAME   = "SegaJungleBookBack_9.bin";
  ...
  {
    return Utils.readBinFile("videoBack_9.bin");
  }
