...
public class Data
{
  ...
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x14de94, 1, 0x8000);  }
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0, 1, 0     );   }
  public OffsetRec getScreensOffset()   { return new OffsetRec(0, 1, 336*39);   }
  public int getBigBlocksCount()        { return 0x1000; }
  public int getScreenWidth()           { return 336; }
  public int getScreenHeight()          { return 39; }
  ...
  private string BACK_NAME   = "SegaJungleBookBack_4.bin";
  ...
  {
    return Utils.readBinFile("videoBack_4.bin");
  }
