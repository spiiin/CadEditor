...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return ZenUtils.getVideoChunk(new[] {"chr8.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return ZenUtils.readPalFromBin(new[] {"pal9.bin"}); }
