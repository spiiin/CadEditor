...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x3040, 1 , 5*184);   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal4-1(a).bin", "pal4-1(b).bin"}); }
