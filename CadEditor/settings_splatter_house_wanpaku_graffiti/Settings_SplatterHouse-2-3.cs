...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x53f3, 1 , 8*56);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SharedUtils.getVideoChunk(new[] {"chr2-3(a).bin", "chr2-3(b).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin(new[] {"pal2-3(a).bin", "pal2-3(b).bin"}); }
