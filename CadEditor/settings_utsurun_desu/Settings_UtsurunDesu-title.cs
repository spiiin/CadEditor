...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1676b, 1 , 16*15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1624b, 1  , 0x1000);  }
  public int getBlocksCount()           { return 128; }
  public int getBigBlocksCount()        { return 128; }
  public int getPalBytesAddr()          { return 0x1664b; }
