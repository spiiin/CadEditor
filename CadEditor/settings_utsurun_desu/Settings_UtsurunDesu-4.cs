...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x649a, 8 , 16*12+48, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x6060, 1  , 0x1000);  }
  public int getBlocksCount()           { return 147; }
  public int getBigBlocksCount()        { return 147; }
  public int getPalBytesAddr()          { return 0x62c0; }
