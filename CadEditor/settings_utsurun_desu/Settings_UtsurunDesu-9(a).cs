...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x10614, 3 , 16*12+48, 16, 12);   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal9(a).bin"); }
