...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4594, 4 , 16*12+48, 16, 12);   }
  ...
  public GetPalFunc           getPalFunc()           { return SharedUtils.readPalFromBin("pal3(a).bin"); }
