...
public class Data
{ 
    public OffsetRec getScreensOffset()   { return new OffsetRec(0x16204 , 3  , 64, 8, 8);      }
    ...
    public GetVideoChunkFunc    getVideoChunkFunc()    { return ThreeUtils.getVideoChunk(new[] {"chr5-2(b).bin"}); }
