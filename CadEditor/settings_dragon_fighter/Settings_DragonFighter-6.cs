...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe610, 1, 170*8); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xee90, 1, 0x1000); }
  public int getBlocksCount()           { return 93; }
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xf610, 1, 0x1000); }
