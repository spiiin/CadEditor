...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa010, 1, 184*8); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xac10, 1, 0x1000); }
  public int getBlocksCount()           { return 128; }
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xb390, 1, 0x1000); }
