...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa610, 1, 184*8); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xb110, 1, 0x1000); }
  public int getBlocksCount()           { return 93; }
  
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0xb890, 1, 0x1000); }
