...
public class Data
{
  ...
  public static OffsetRec getPalOffset()       { return new OffsetRec(0x475A0, 1  , 16);     }
  public static OffsetRec getVideoOffset()     { return new OffsetRec(0x23010, 1   , 0x1000); }
  public static OffsetRec getVideoObjOffset()  { return new OffsetRec(0x20010, 1   , 0x1000); } //
  public static OffsetRec getBigBlocksOffset() { return new OffsetRec(0x46510 , 1  , 0x4000); }
  public static OffsetRec getBlocksOffset()    { return new OffsetRec(0x46010 , 1  , 0x4000); }
  public static OffsetRec getScreensOffset()   { return new OffsetRec(0x46910 , 32 , 0x40);   }
