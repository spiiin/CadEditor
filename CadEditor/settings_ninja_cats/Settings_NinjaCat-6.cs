...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(4843, 23 , 8*5, 5, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()             { return NinjaCatUtils.getVideoChunk("chr6.bin");   }
  ...
  public GetPalFunc           getPalFunc()                    { return NinjaCatUtils.readPalFromBin("pal6.bin"); }
