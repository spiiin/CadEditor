...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xe635, 17 , 8*6, 8, 6);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0xe965, 1  , 0x1000);  }
  public int getBlocksCount()           { return 94; }
  public int getBigBlocksCount()        { return 94; }
  public int getPalBytesAddr()          { return 0xef45; }
