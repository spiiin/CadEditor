...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x6139, 9, 48, 8, 6); }
  ...
  public OffsetRec getPalOffset()     { return new OffsetRec(0x1f8fa, 16, 16   ); }
  ...
  public byte[] getPallete(int palId)
  {
    var pallete = new byte[] { 
      0x0f, 0x01, 0x16, 0x20, 0x0f, 0x0c, 0x1c, 0x2c,
      0x0f, 0x10, 0x20, 0x21, 0x0f, 0x00, 0x10, 0x30
    }; 
    return pallete;
  }
}