...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x5239, 9, 48, 8, 6); }
  ...
  public OffsetRec getPalOffset()     { return new OffsetRec(0x1f851, 16, 16   ); }
  ...
  public byte[] getPallete(int palId)
  {
    var pallete = new byte[] { 
      ...
      0x0f, 0x00, 0x06, 0x26, 0x0f, 0x00, 0x10, 0x20
    }; 
    return pallete;
  }
}