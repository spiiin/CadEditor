...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x1b0f, 10 , 16*15+1, 16, 15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x16e9, 1  , 0x1000);  }
  public int getBlocksCount()           { return 253; }
  public int getBigBlocksCount()        { return 253; }
  public int getPalBytesAddr()          { return 0x54e1; }
