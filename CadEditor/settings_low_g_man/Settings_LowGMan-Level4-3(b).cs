...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xbb2d, 2 , 16*12, 16, 12);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr4-3.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal4-3.bin"); }
