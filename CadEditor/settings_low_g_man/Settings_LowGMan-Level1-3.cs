...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x52c8, 1 , 16*36);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr1-3.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal1-3.bin"); }
