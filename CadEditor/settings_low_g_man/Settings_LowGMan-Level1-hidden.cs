...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x583e, 2 , 16*12);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr-hidden1.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal-hidden1.bin"); }
