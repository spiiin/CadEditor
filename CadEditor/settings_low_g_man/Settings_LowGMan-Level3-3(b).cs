...
public class Data 
{  
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x9956, 1 , 16*15, 16, 15);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return LowGManUtils.getVideoChunk("chr3-3.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return LowGManUtils.readPalFromBin("pal3-3.bin"); }
