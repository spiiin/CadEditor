...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x14919, 1, 12*304); }
  public int getScreenWidth()         { return 12; }
  public int getScreenHeight()        { return 304; }
  ...
  {
      return Utils.readBinFile("pal-classroom.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-classroom.bin", videoPageId);
  }
}