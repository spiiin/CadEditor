...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x18dd1, 1, 12*64); }
  ...
  {
      return Utils.readBinFile("pal-weightroom.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-weightroom.bin", videoPageId);
  }
}