...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x368, 1, 12*496); }
  public int getScreenWidth()         { return 12; }
  public int getScreenHeight()        { return 496; }
  ...
  public int getPalBytesAddr()          { return 0x2ad; }
  ...
  {
      return Utils.readBinFile("pal-entrance.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-entrance.bin", videoPageId);
  }
}