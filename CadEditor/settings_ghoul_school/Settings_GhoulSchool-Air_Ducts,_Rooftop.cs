...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x163ed, 1, 12*256); }
  ...
  {
      return Utils.readBinFile("pal-airducts.bin");
  }
  ...
  {
     return Utils.readVideoBankFromFile("chr-airducts.bin", videoPageId);
  }
}