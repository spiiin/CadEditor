...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x6a89, 10 , 16*13, 16, 13);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x31c8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 184; }
  public int getBigBlocksCount()        { return 184; }
  public int getPalBytesAddr()          { return 0x3790; }
