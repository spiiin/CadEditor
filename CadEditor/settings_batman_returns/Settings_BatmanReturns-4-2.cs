...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x6b10, 5 , 8*6);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return SuperCUtils.getVideoChunk(new[] {"chr4-2.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return SuperCUtils.readPalFromBin(new[] {"pal4-2.bin"}); }
