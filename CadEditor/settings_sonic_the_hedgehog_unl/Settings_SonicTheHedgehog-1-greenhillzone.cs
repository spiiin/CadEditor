...
public class Data 
{ 
  public OffsetRec getScreensOffset() { return new OffsetRec(0x10, 64, 16*16, 16, 16); }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x1a010, 1  , 0x1000);  }
  ...
  public byte[] getVideoChunk(int videoPageId)
  {
     if (videoPageId == 0)
     {
        return Utils.readVideoBankFromFile("chr1-1(a).bin", 0);
     }
     else if (videoPageId == 1)
     {
       return Utils.readVideoBankFromFile("chr1-1(b).bin", 0);
     }
     else
     {
       return Utils.readVideoBankFromFile("chr1-1(c).bin", 0);
     }
  }
}