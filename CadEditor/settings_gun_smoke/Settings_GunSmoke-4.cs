...
public class Data
{ 
  public OffsetRec getScreensOffset()     { return new OffsetRec(0xc410, 1, 8*117, 8, 117);  }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()             { return GunSmokeUtils.getVideoChunk(new[] {"chr4.bin", "chr4-2.bin"}); }
  ...
  public GetPalFunc           getPalFunc()                    { return GunSmokeUtils.readPalFromBin(new[] {"pal4.bin"}); }
