...
public class Data
{
  ...
  public static OffsetRec getPalOffset()       { return new OffsetRec(0x4B5A0, 1  , 16);     }
  public static OffsetRec getVideoOffset()     { return new OffsetRec(0x2D010, 1   , 0x1000); }
  public static OffsetRec getVideoObjOffset()  { return new OffsetRec(0x20010, 1   , 0x1000); } //
  public static OffsetRec getBigBlocksOffset() { return new OffsetRec(0x4A510 , 1  , 0x4000); }
  public static OffsetRec getBlocksOffset()    { return new OffsetRec(0x4A010 , 1  , 0x4000); }
  public static OffsetRec getScreensOffset()   { return new OffsetRec(0x4A910 , 32 , 0x40);   }
  ...
  {
    new LevelRec(0x10000, 1, 8, 4,  0x4B510), 
  };
