...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x6058, 20 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x76d8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 109; }
  public int getBigBlocksCount()        { return 109; }
  public int getPalBytesAddr()          { return 0x7ad8; }
