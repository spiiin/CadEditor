...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x2058, 24 , 16*12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x36d8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 106; }
  public int getBigBlocksCount()        { return 106; }
  public int getPalBytesAddr()          { return 0x3ad8; }
