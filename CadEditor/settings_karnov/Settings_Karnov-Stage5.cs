...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8058, 18 , 16*12, 16, 12);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x96d8, 1  , 0x1000);  }
  public int getBlocksCount()           { return 207; }
  public int getBigBlocksCount()        { return 207; }
  public int getPalBytesAddr()          { return 0x9ad8; }
