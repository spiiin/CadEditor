...
v4.6
- Lzkn1-компрессор и плагин сжатия данных для Contra Hard Corps
- Редактор блоков для сеги
  Фикс отрисовки, корректный показ скроллов, отображение всех блоков, сетка, опция повторения для всех тайлов блока
- Изменена логика открытия конфига (в самом конфиге прописывается, используется ли дамп в дополнение к ROM-файлу)
- Фикс конфига для Zombies Ate My Neighbors
...
- Конфиги уровней
  ...
  Captain America [NES] - экраны блоки 2 уровня.
- Редактор врагов:
...
-------------------------------------------------------------------------------
  ...
  lancuster   - конфиги для игр Dragon Fighter, Cheetahmen 2, Captain America, TMNT 1, Jackie Chan, Gun Smoke, Batman, Monster in my Pocket, Super C, Captain Planet
