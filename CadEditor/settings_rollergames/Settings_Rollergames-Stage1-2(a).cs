...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4e9d, 10 , 8*8);   }
  ...
  public GetPalFunc           getPalFunc()           { return RollergamesUtils.readPalFromBin(new[] {"pal1-2.bin"}); }
