...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x5a13, 31 , 8*8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return RollergamesUtils.getVideoChunk(new[] {"chr2(a).bin", "chr2(b).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return RollergamesUtils.readPalFromBin(new[] {"pal2(a).bin", "pal2(b).bin"}); }
