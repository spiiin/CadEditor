...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8095, 15 , 8*8, 8, 8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return RollergamesUtils.getVideoChunk(new[] {"chr3-1.bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return RollergamesUtils.readPalFromBin(new[] {"pal3-1.bin"}); }
