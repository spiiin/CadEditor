...
public class Data 
{ 
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x4010, 5 , 16*15);   }
  ...
  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x44c0, 1  , 0x1000);  }
  public int getBlocksCount()           { return 121; }
  public int getBigBlocksCount()        { return 121; }
  public int getPalBytesAddr()          { return 0x46fa; }
