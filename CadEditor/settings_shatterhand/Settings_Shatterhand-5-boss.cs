...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xE5C7, 1, 8*8, 8, 8);   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal5-3.bin"}); }
