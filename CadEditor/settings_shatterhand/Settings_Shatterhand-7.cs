...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0xa987 - 64*4, 26, 8*8);   }
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return ShatterhandUtils.getVideoChunk("chr7.bin");   }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin("pal7.bin"); }
