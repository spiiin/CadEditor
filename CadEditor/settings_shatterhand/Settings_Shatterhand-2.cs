...
public class Data 
{
  ...
  public OffsetRec getScreensOffset()  { return new OffsetRec(0x8D9f, 5 /*12*/ , 8*8, 8, 8);   }

  public OffsetRec getBlocksOffset()    { return new OffsetRec(0x909F, 1, 0x400); }
  public int getPalBytesAddr()          { return 0x929F; }
  public OffsetRec getBigBlocksOffset() { return new OffsetRec(0x931F, 1, 0x4000);  }
  ...
  public GetPalFunc           getPalFunc()           { return ShatterhandUtils.readPalFromBin(new[]{"pal2.bin", "pal2-2.bin"}); }
